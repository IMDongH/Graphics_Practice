...
window.onload = function init() {
    ...
    canvas.addEventListener("mousedown", function(event){
        ...
        // makeStar(2*event.clientX/canvas.width-1
...
// vertices = [...vertices, ...makeSnow(100,100,50,canvas.width,canvas.height)]
    var colors = [
        //background
        vec4(1, 1, 1, 1),
        vec4(0, 0, 0, 1),
    ...
    // gl.uniform4fv(size, [0.1, 0.1, 0.1, 0.1]);
    ...
    gl.drawArrays(gl.TRIANGLES, 63, 9);
   };
...
gl.bindBuffer( gl.ARRAY_BUFFER, vBuffer );
gl.bufferSubData(gl.ARRAY_BUFFER, 8*index, flatten(t));
gl.drawArrays( gl.TRIANGLES, click, click+9 );
click=click+9;
